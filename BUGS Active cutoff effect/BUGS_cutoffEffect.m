...
outfile_metrics = sprintf('Results/Output_BUGS_metrics_n_%d_p_%d_rep_%d.csv', n, p, rep);
...
outfile_draws = sprintf('Results/Output_BUGS_beta_draws_top%d_n_%d_p_%d_rep_%d.csv', ...
    true_p, n, p, rep);
...
outfile_plot = sprintf('Results/Output_BUGS_forest_density_top%d_n_%d_p_%d_rep_%d.png', ...
    true_p, n, p, rep);
