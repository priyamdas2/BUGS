...
outfile_pred = fullfile(outdir, 'Output_8020_UNguided_cv_test_predictions.csv');
...
outfile_metrics = fullfile(outdir, 'Output_8020_UNguided_cv_metrics.csv');
...
outfile_hdraws = fullfile(outdir, 'Output_8020_UNguided_cv_hyper_draws.csv');
...
outfile_hsummary = fullfile(outdir, 'Output_8020_UNguided_cv_hyper_summary.csv');
...
outfile_split = fullfile(outdir, 'Output_8020_UNguided_cv_split.csv');
